...
function EditSubCategory({ close,data,fetchData }) {
        ...
        <section className='fixed top-0 right-0 bottom-0 left-0 bg-neutral-800 bg-opacity-70 z-50 flex items-center justify-center p-4'>
            <div className='w-full max-w-5xl bg-white p-4 rounded'>
                ...
                <form className='my-3 grid gap-3 ' onSubmit={handleSubmitSubCategory}>
                    ...
                    <div className='grid gap-1'>
                        <p>Image</p>
                        <div className='flex flex-co lg:flex-row items-center gap-3'>
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='border focus-within:border-primary-200 rounded'>
                            ...
                            <select className='w-full p-2 bg-transparent outline-none border' onChange={(e)=>{
                                ...
                                const categoryDetaiils=allCategory.find(el=>el._id==value)

                                setSubCategoryData((preve)=>{
                                    return {
                                        ...preve,
                                        category : [...preve.category,categoryDetaiils]
                                    }
                                })
