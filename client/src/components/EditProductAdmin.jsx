...
function EditProductAdmin({close,data:propsData,fetchProductData}) {
  ...
  const [selectSubCategory, setSeleteSubCategory] = useState("")
  ...
  const handleDelteImage = async (index) => {
        ...
        <section>
          ...
          <div className='grid p-3'>
            <form className='grid gap-4' onSubmit={handleSubmit}>
                    ...
                    data.image.map((img, index) => {
                      return (
                        <div key={img + index} className='h-20 mt-1 w-20 min-w-20 bg-blue-50 border relative group'>
                          ...
                          />
                          <div onClick={() => handleDelteImage(index)} className='absolute bottom-0 right-0 p-1 bg-red-600 hover:bg-red-600 rounded text-white hidden group-hover:block cursor-pointer'>
                            <MdDelete />
                          </div>
              ...
              <div className='grid gap-1'>
                <label htmlFor='stock' className='font-medium'>No of Stock</label>
                <input
                  id='stock'
                  type="number"
