...
function Category() {
    ...
    return (
        <section>
            ...
            {/* display all item with map method */}
                    ...
                    return (
                        ...
                        key={category._id}>
                            ...
                            <div className=' items-center h-9  flex gap-2'>
                                <button onClick={()=>{setOpenEdit(true); setEditData(category)}} className='flex-1 bg-green-100 text-green-700 hover:bg-green-300 font-medium py-1 rounded'>Edit</button>
                                <button onClick={()=>{
                                    setOpenConfirmBoxDelete(true) ;
                                    setDeleteCategory(category)

                                }} className='flex-1 bg-red-100 text-red-700 hover:bg-red-300 font-medium py-1 rounded'>Delete</button>
                            </div>
                        </div>
                    )
                })
